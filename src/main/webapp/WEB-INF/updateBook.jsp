                    ...
                    <form:form action="/updateBook" method="post" modelAttribute="updateBook">
                        <div class="form-group row py-1">
                            ...
                            <div class="col-md-8">
                                ...
                                <form:input type="text" path="title" class="form-control" value="${book.getTitle()}"/>
                            </div>
                        </div>
                        <div class="form-group row py-1">
                            ...
                            <div class="col-md-8">
                                ...
                                <form:input type="text" path="authorName" class="form-control" value="${book.getAuthorName()}"/>
                            </div>
                        </div>
                        <div class="form-group row py-1">
                            ...
                            <div class="col-md-8">
                                ...
                                <form:input type="text" path="description" class="form-control" value="${book.getDescription()}"/>
                            </div>
                        </div>
